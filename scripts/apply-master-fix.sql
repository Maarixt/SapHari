-- Master Access Fix - Run this in Supabase SQL Editor
...
-- 2. Create a comprehensive master check that works with both systems
...
-- 5. Fix RLS policies for devices table
